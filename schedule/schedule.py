...
class Schedule(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.end_time_label.pack(side='left', padx=self.frame_padding, pady=self.frame_padding)
        ...
        self.start_time_label.pack(side='left', padx=self.frame_padding, pady=self.frame_padding)
